...
namespace Movies.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        private async Task InitNotificationsAsync()
        {
            ...
            var hub = new NotificationHub(NotificationHubData.NotificationHubName,
                                          NotificationHubData.ListenConnectionString);
